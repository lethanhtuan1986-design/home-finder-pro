    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="bg-muted/50 rounded-lg p-5 space-y-2 text-sm text-foreground">
          <p>
            <span className="font-medium">Tên công ty:</span> CÔNG TY CỔ PHẦN
            GIẢI PHÁP SỐ GSL
          </p>
          <p className="text-muted-foreground italic">
            (GSL DIGITAL SOLUTIONS JOINT STOCK COMPANY)
          </p>
          <p>
            <span className="font-medium">Mã số thuế:</span> 0111320005
          </p>
          <p>
            <span className="font-medium">Địa chỉ:</span> Tầng 3, 105 Láng Hạ,
            Quận Đống Đa, TP Hà Nội, Việt Nam
          </p>
          <p className="text-muted-foreground italic">
            (Floor 3, No.105 Lang Ha, Dong Da District, Ha Noi, Vietnam)
          </p>
        </div>
      </div>
  ...
  <div className="space-y-6">
    ...
    <Article title="Điều 1. Mục đích và phạm vi">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Chính sách này quy định cách thức Xanh ID thu thập, sử dụng, lưu trữ
          và bảo vệ dữ liệu cá nhân của người dùng.
        </li>
        <li>
          Việc cài đặt, đăng ký hoặc sử dụng ứng dụng Xanh ID đồng nghĩa với
          việc bạn đã đọc, hiểu và đồng ý với Chính sách bảo mật này.
        </li>
      </ol>
    </Article>
    ...
    <Article title="Điều 2. Loại dữ liệu thu thập">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          <strong>Thông tin định danh:</strong> Họ tên, email, số điện thoại, ID
          tài khoản.
        </li>
        <li>
          <strong>Thông tin kỹ thuật:</strong> Thiết bị, hệ điều hành, địa chỉ
          IP, log truy cập.
        </li>
        <li>
          <strong>Thông tin đăng nhập bên thứ ba</strong> (Facebook, Google,
          Apple) chỉ dùng cho mục đích xác thực.
        </li>
      </ol>
    </Article>
      ...
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li>
          ...
          <ol className="list-[lower-alpha] list-inside ml-4 mt-1 space-y-1">
            ...
            <li>
              Đối tác kỹ thuật phục vụ vận hành hệ thống trong phạm vi cần
              thiết.
            </li>
          </ol>
        </li>
    ...
    <Article title="Điều 5. Lưu trữ và bảo mật">
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li>
          Áp dụng các biện pháp kỹ thuật để ngăn chặn truy cập trái phép, mất
          mát dữ liệu.
        </li>
        <li>
          Thời gian lưu trữ dữ liệu phù hợp với mục đích sử dụng hoặc theo quy
          định pháp luật.
        </li>
      </ol>
    </Article>
    ...
    <Article title="Điều 7. Dữ liệu trẻ em">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Xanh ID không chủ đích thu thập dữ liệu của trẻ em dưới 13 tuổi.
        </li>
        <li>
          Nếu phát hiện dữ liệu trẻ em được thu thập trái phép, chúng tôi sẽ xóa
    ...
    <Article title="Điều 8. Thay đổi chính sách">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Chính sách bảo mật có thể được cập nhật theo yêu cầu pháp lý hoặc thay
          đổi dịch vụ.
        </li>
      </ol>
    </Article>
    ...
    <Article title="Điều 9. Hiệu lực">
      <p>
        Chính sách bảo mật này có hiệu lực kể từ ngày người dùng chấp nhận khi
        sử dụng ứng dụng Xanh ID.
      </p>
    </Article>
  </div>
);
...
const ComplaintSection = () => (
  <div className="space-y-6">
    <div>
      <h2 className="text-2xl font-bold text-foreground">
        Cơ chế giải quyết khiếu nại, tranh chấp – Xanh ID
      </h2>
      <p className="text-sm text-muted-foreground mt-1">
    ...
    <Article title="Điều 1. Nguyên tắc giải quyết khiếu nại, tranh chấp">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Khi phát sinh khiếu nại hoặc tranh chấp liên quan đến việc sử dụng
          dịch vụ Xanh ID, Công ty Cổ Phần Giải Pháp Số GSL ưu tiên áp dụng biện
          pháp thương lượng, hòa giải trên tinh thần hợp tác, tôn trọng quyền và
          lợi ích hợp pháp của các bên.
        </li>
        <li>
          Việc giải quyết khiếu nại được thực hiện minh bạch, khách quan, đúng
    ...
    <Article title="Điều 2. Phạm vi trách nhiệm">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Xanh ID không chịu trách nhiệm về tính chính xác, hợp pháp của nội
          dung, thông tin do người dùng tự đăng tải hoặc cung cấp.
        </li>
        <li>
          Trong phạm vi quyền hạn của mình, Xanh ID sẽ hỗ trợ người dùng xử lý
          các phản ánh, khiếu nại liên quan đến nội dung vi phạm quy định, bao
          gồm nhưng không giới hạn ở việc ẩn, gỡ bỏ nội dung, cảnh báo hoặc khóa
          tài khoản vi phạm.
        </li>
      </ol>
    </Article>
    ...
    <Article title="Điều 3. Quy trình giải quyết khiếu nại, tranh chấp">
      <div className="space-y-4">
        <div className="flex gap-3">
          ...
          <p>
            <strong>Bước 1:</strong> Người dùng gửi khiếu nại, phản ánh qua
            email:{" "}
            <a
              href="mailto:hotroxanhstay@gmail.com"
        ...
        <div className="flex gap-3">
          ...
          <p>
            <strong>Bước 2:</strong> Bộ phận Chăm sóc khách hàng của Xanh ID
            tiếp nhận, xác minh nội dung khiếu nại. Tùy theo tính chất và mức
            độ, Xanh ID sẽ áp dụng biện pháp hỗ trợ phù hợp nhằm giải quyết
            tranh chấp.
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <p>
            <strong>Bước 3:</strong> Trường hợp khiếu nại, tranh chấp vượt quá
            thẩm quyền xử lý của Xanh ID, Công ty sẽ hướng dẫn người dùng đưa vụ
            việc tới cơ quan nhà nước có thẩm quyền để giải quyết theo quy định
            pháp luật.
          </p>
        </div>
      </div>
    ...
    <Article title="Điều 4. Thời hạn xử lý">
      <ol className="list-decimal list-inside space-y-2">
        <li>
          Đối với các khiếu nại thuộc phạm vi xử lý của Xanh ID, thời hạn phản
          hồi và xử lý dự kiến từ 03 (ba) đến 05 (năm) ngày làm việc kể từ ngày
          nhận được khiếu nại hợp lệ.
        </li>
        <li>
          Đối với các tranh chấp vượt quá thẩm quyền, thời hạn giải quyết phụ
          thuộc vào tiến độ xử lý của cơ quan nhà nước có thẩm quyền.
        </li>
      </ol>
    </Article>
    ...
    <Article title="Điều 5. Hiệu lực">
      <p>
        Cơ chế giải quyết khiếu nại, tranh chấp này có hiệu lực kể từ thời điểm
        được công bố và áp dụng trong suốt quá trình người dùng sử dụng dịch vụ
        Xanh ID.
      </p>
    </Article>
  </div>
        ...
        <div className="bg-primary/5 border-b border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
            ...
            <p className="text-muted-foreground mt-2 text-sm md:text-base">
              Chính sách bảo mật và điều khoản sử dụng dịch vụ của XanhStay &
              XanhID.
            </p>
          </div>
        </div>
