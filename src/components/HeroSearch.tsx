            ...
            <div className="flex flex-col md:flex-row items-stretch gap-2">
              ...
              <div className="flex gap-2 items-center">
                ...
                <button
                  ...
                  className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-xl font-medium transition-all active:scale-95 flex items-center justify-center gap-2 whitespace-nowrap h-fit"
                >
                  <Search size={20} />
