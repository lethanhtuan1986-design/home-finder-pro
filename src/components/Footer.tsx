...
export const Footer = () => {
  ...
  const linkClass = "text-muted-foreground hover:text-primary transition-colors duration-300";
  const socialClass =
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 max-w-sm">
            <div className="flex items-center gap-2 mb-5">
              <img src="/images/logo.svg" alt="XanhStay" className="h-9 brightness-0 invert" />
            </div>
          ...
          {/* Col 2 – Khám phá */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-gray-100 mb-4">{t("footer.explore")}</h4>
          ...
          {/* Col 3 – Hỗ trợ */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-gray-100 mb-4">{t("footer.support")}</h4>
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/policy?tab=about" className={linkClass}>
                  {t("footer.contact")}
          ...
          {/* Col 4 – Kết nối */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-gray-100 mb-4">{t("footer.follow")}</h4>
            <ul className="space-y-3 text-sm">
              <li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-8">
          <div className="flex flex-col md:flex-row md:justify-between gap-6 text-sm">
            <div className="space-y-2 text-center md:text-left">
              <p className="font-semibold text-gray-100">{t("footer.companyName")}</p>
